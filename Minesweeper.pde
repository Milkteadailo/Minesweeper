...
public void displayLosingMessage() {
    ...
    buttons[11][11].setLabel("T");
    buttons[11][12].setLabel("R");
    buttons[11][13].setLabel("Y");
    buttons[12][10].setLabel("A");
    buttons[12][11].setLabel("G");
    buttons[12][12].setLabel("A");
    buttons[12][13].setLabel("I");
    ...
    buttons[12][13].setLabel("N");
    buttons[12][14].setLabel("E");
    buttons[12][15].setLabel("R");
